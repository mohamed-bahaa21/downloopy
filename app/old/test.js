  ...
  for (var i = fpage; i <= fpage + 5 - 1; i++) {
    request.head(uri, function (err, res, body) {
      ...
      if (res.headers["content-type"] == "text/html;charset=utf-8") {
        request(uri)
          .pipe(fs.createWriteStream(html_name))
          .on("close", () => {
